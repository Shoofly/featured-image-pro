...
if ( !class_exists( 'Featured_Image_Pro_Masonry_Widget' ) ) {
	...
	class Featured_Image_Pro_Masonry_Widget extends WP_Widget {
		...
		function admin_scripts_method( $hook ) {
            ...
            wp_enqueue_style( 'proto_widget_styles', plugins_url('assets/third-party/jquery-ui-1.12.1/jquery-ui.theme.min.css', __FILE__), array(), '2.0' );
            wp_enqueue_style( 'proto_widget_styles', plugins_url('assets/third-party/jquery-ui-1.12.1/jquery-ui.min.css', __FILE__), array(), '2.0' );
            wp_enqueue_script( 'jquery-ui-accordion' );
            wp_enqueue_style( 'wp-color-picker' );
            wp_enqueue_script( 'wp-color-picker' );
            wp_enqueue_script( 'proto_widgets_js', plugins_url('assets/js/widget.js', __FILE__), array('jquery', 'jquery-ui-accordion', 'customize-controls', 'wp-color-picker'), '2.3', TRUE );
...
?>
                    ...
                    <div id="collapse8" class="<?php echo $div_class; ?>" role="tabpanel" aria-labelledby="heading8">
                        <textarea style='width:100%' name='<?php echo $this->get_field_name('shortcode')?>' id='<?php echo $this->get_field_id('shortcode') ?>' class='proto_shortcode' onClick='this.select();'><?php echo $shortcode; ?></textarea>
