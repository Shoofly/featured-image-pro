...
if ( !function_exists( 'featured_image_pro_post_masonry_register_scripts' ) ) {
	...
	{
		wp_register_style( 'featured_image_pro_masonry_style', plugins_url( 'assets/css/proto-masonry.css', __FILE__ ), array(), '8.4' );
		wp_register_script('jquery.dotdotdot', plugins_url('assets/third-party/jQuery.dotdotdot/src/jquery.dotdotdot.js', __FILE__), array(), '1.0', TRUE);
	...
	/*	public function featured_image_pro_post_doscript() {
		...
		function basic_options( $options, $args ) {
			...
			$defaults = array(
					...
					'excerpt_custom_link_style' => '',		//span, div or button
			);
